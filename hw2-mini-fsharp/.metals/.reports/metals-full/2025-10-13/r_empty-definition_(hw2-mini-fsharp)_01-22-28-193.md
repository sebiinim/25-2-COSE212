error id: file:///D:/coding/COSE212-plrg-hw/hw2-mini-fsharp/src/main/scala/kuplrg/Implementation.scala:kuplrg/Case#
file:///D:/coding/COSE212-plrg-hw/hw2-mini-fsharp/src/main/scala/kuplrg/Implementation.scala
empty definition using pc, found symbol in pc: kuplrg/Case#
...
object Implementation extends Template {
  ...
  def interp(expr: Expr, env: Env): Value = expr match {
      ...
      lazy val recEnv: Env = {
        funs.foldLeft(env) {
          case (acc, NamedFun(name, param, fbody)) => 
            acc + (name -> CloV(param, fbody, () => recEnv))  // 지연 참조
        }
      } 
      interp(scope, recEnv)
    ...
    case EMatch(value, cases) => 
      ...
      def loop(cs: List[Ca@@se]): Value = cs match {
