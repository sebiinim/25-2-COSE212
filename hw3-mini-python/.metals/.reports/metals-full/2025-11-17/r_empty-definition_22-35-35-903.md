error id: file:///D:/coding/COSE212-plrg-hw/hw3-mini-python/src/main/scala/kuplrg/MiniPython.scala:kuplrg/Error.NameError.
file:///D:/coding/COSE212-plrg-hw/hw3-mini-python/src/main/scala/kuplrg/MiniPython.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/util/parsing/combinator/NameError.
	 -scala/util/parsing/combinator/NameError#
	 -scala/util/parsing/combinator/NameError().
	 -Expr.NameError.
	 -Expr.NameError#
...
enum Error:
  ...
  def str: String = this match
    ...
    case NameEr@@ror(x)      => s"NameError: $x"
