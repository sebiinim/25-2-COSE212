error id: file:///D:/coding/COSE212-plrg-hw/hw3-mini-python/src/main/scala/kuplrg/MiniPython.scala:`<none>`.
file:///D:/coding/COSE212-plrg-hw/hw3-mini-python/src/main/scala/kuplrg/MiniPython.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/util/parsing/combinator/newline.
	 -scala/util/parsing/combinator/newline#
	 -scala/util/parsing/combinator/newline().
	 -Expr.newline.
	 -Expr.newline#
	 ...
	 -newline#
	 -newline().
	 -scala/Predef.newline.
	 -scala/Predef.newline#
	 -scala/Predef.newline().
offset: 204
uri: file:///D:/coding/COSE212-plrg-hw/hw3-mini-python/src/main/scala/kuplrg/MiniPython.scala
text:
```scala
package kuplrg
...
case class Program(stmts: List[Stmt], expr: Expr):
  ...
  def str: String = stmts.map(_.str(0) + new@@line(0)).mkString + expr.str
